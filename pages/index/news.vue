<template>
	<view>
		...
		<view class="cu-list menu-avatar">
			...
			<view class="cu-item solid-top">
				<view class="cu-avatar radius lg" style="background-image:url(https://ossweb-img.qq.com/images/lol/web201310/skin/big21016.jpg );"></view>
				<view class="content">
					<view class="text-grey">拉克丝</view>
					<view class="text-gray text-sm flex">
						<text class="text-cut">
							我已天理为凭，踏入这片荒芜，不再受凡人的枷锁遏制。我已天理为凭，踏入这片荒芜，不再受凡人的枷锁遏制。
						</text> </view>
				...
				<view class="action">
					<view class="text-grey text-xs">12:26</view>
					<view class="cu-tag round bg-blue sm">3</view>
				</view>
			</view>
		</view>
	</view>
